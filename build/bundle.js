...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "23e0fc4f3503484da2e85f48699c013c.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var togglePlaying = function togglePlaying() {
		var state = arguments.length <= 0 || arguments[0] === undefined ? { isPlaying: false, title: '' } : arguments[0];
		var action = arguments[1];
	...
	var toggleInstructions = function toggleInstructions() {
		...
		switch (action.type) {
			case _Actions.TOGGLE_INSTRUCTIONS:
...
/***/ function(module, exports) {
	...
	function toggleInstructions(instructions) {
		return {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
		return {
			onCloseClick: function onCloseClick() {
				dispatch((0, _Actions.toggleInstructions)(false));
			}
		};
	};

	var InstructionsContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Instructions2.default);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      if (showInstructions === true) {
	        return _react2.default.createElement(
	          'div',
	          { className: 'header', style: { position: 'absolute', top: 0, bottom: 0, left: 0, right: 0 }, onClick: function onClick() {
	              onCloseClick(false);
	            } },
	          ...
	          _react2.default.createElement(
	            'p',
	            null,
	            'Click a number to change soundboards.'
	          ),
	          _react2.default.createElement(
	            'p',
	            null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LetterContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Letter2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NumberKeyContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Number2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AnimationElementsContainer = (0, _reactRedux.connect)(mapStateToProps)(_AnimationElements2.default);
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      if (animation === 'Wizard') {
	        return _react2.default.createElement('div', { id: 'animElement1', className: 'wizard' });
	      } else {
	        return _react2.default.createElement(
	          'div',
	          null,
	          _react2.default.createElement('div', { className: 'hidden-wizard' })
	        );
	      }
	    }
	  }]);
